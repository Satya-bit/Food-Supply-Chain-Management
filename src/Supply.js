...
function Supply() {
    ...
    return (
        <div>
            ...
            <p>Product Order -&gt; Farmer -&gt; Processor -&gt; Distributor -&gt; Retailer -&gt; Consumer</p>
            ...
            <h5><b>Step 1: Harvest</b>(Only a registered Farmer can perform this step):-</h5>
            ...
            <hr />
            <br />
            <h5><b>Step 2: Process</b>(Only a registered Processor can perform this step):-</h5>
            <form onSubmit={handlerSubmitManufacturing}>
                <input className="form-control-sm" type="text" onChange={handlerChangeID} placeholder="Enter Product ID" required />
                <button className="btn btn-outline-success btn-sm" onSubmit={handlerSubmitManufacturing}>Process</button>
            </form>
            <hr />
            <br />
